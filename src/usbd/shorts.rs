...
pub type Ep0datadoneStartepin0W<'a, REG> =
    crate::BitWriter<'a, REG, Ep0datadoneStartepin0>;
...
pub type Ep0datadoneStartepout0W<'a, REG> =
    crate::BitWriter<'a, REG, Ep0datadoneStartepout0>;
...
pub type Ep0datadoneEp0statusW<'a, REG> =
    crate::BitWriter<'a, REG, Ep0datadoneEp0status>;
...
and task EP0STATUS"]
pub type Endepout0Ep0statusW<'a, REG> =
    crate::BitWriter<'a, REG, Endepout0Ep0status>;
...
and task EP0RCVOUT"]
pub type Endepout0Ep0rcvoutW<'a, REG> =
    crate::BitWriter<'a, REG, Endepout0Ep0rcvout>;
...
impl W {
    #[doc = "Bit 0 - Shortcut between event EP0DATADONE and task STARTEPIN\\[0\\]"]
    #[inline(always)]
    pub fn ep0datadone_startepin0(
        &mut self,
    ) -> Ep0datadoneStartepin0W<ShortsSpec> {
        Ep0datadoneStartepin0W::new(self, 0)
    }
    #[doc = "Bit 1 - Shortcut between event EP0DATADONE and task STARTEPOUT\\[0\\]"]
    #[inline(always)]
    pub fn ep0datadone_startepout0(
        &mut self,
    ) -> Ep0datadoneStartepout0W<ShortsSpec> {
        Ep0datadoneStartepout0W::new(self, 1)
    }
    #[doc = "Bit 2 - Shortcut between event EP0DATADONE and task EP0STATUS"]
    #[inline(always)]
    pub fn ep0datadone_ep0status(
        &mut self,
    ) -> Ep0datadoneEp0statusW<ShortsSpec> {
