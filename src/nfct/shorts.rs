...
pub type FielddetectedActivateW<'a, REG> =
    crate::BitWriter<'a, REG, FielddetectedActivate>;
...
pub type TxframeendEnablerxdataW<'a, REG> =
    crate::BitWriter<'a, REG, TxframeendEnablerxdata>;
...
impl W {
    #[doc = "Bit 0 - Shortcut between event FIELDDETECTED and task ACTIVATE"]
    #[inline(always)]
    pub fn fielddetected_activate(
        &mut self,
    ) -> FielddetectedActivateW<ShortsSpec> {
    ...
    #[doc = "Bit 5 - Shortcut between event TXFRAMEEND and task ENABLERXDATA"]
    #[inline(always)]
    pub fn txframeend_enablerxdata(
        &mut self,
    ) -> TxframeendEnablerxdataW<ShortsSpec> {
