...
pub type TasksCalibrateoffsetW<'a, REG> =
    crate::BitWriter<'a, REG, TasksCalibrateoffset>;
...
impl W {
    ...
    #[inline(always)]
    pub fn tasks_calibrateoffset(
        &mut self,
    ) -> TasksCalibrateoffsetW<TasksCalibrateoffsetSpec> {
