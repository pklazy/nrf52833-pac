...
pub type CteerrorhandlingW<'a, REG> =
    crate::BitWriter<'a, REG, Cteerrorhandling>;
...
pub type CtetimevalidrangeW<'a, REG> =
    crate::FieldWriter<'a, REG, 2, Ctetimevalidrange>;
...
pub type Cteinlinerxmode1usW<'a, REG> =
    crate::FieldWriter<'a, REG, 3, Cteinlinerxmode1us>;
...
pub type Cteinlinerxmode2usW<'a, REG> =
    crate::FieldWriter<'a, REG, 3, Cteinlinerxmode2us>;
...
impl W {
    ...
    #[doc = "Bits 6:7 - Max range of CTETime"]
    #[inline(always)]
    pub fn ctetimevalidrange(
        &mut self,
    ) -> CtetimevalidrangeW<CteinlineconfSpec> {
        CtetimevalidrangeW::new(self, 6)
    }
    #[doc = "Bits 10:12 - Spacing between samples for the samples in the SWITCHING period when CTEINLINEMODE is set."]
    #[inline(always)]
    pub fn cteinlinerxmode1us(
        &mut self,
    ) -> Cteinlinerxmode1usW<CteinlineconfSpec> {
        Cteinlinerxmode1usW::new(self, 10)
    }
    #[doc = "Bits 13:15 - Spacing between samples for the samples in the SWITCHING period when CTEINLINEMODE is set."]
    #[inline(always)]
    pub fn cteinlinerxmode2us(
        &mut self,
    ) -> Cteinlinerxmode2usW<CteinlineconfSpec> {
