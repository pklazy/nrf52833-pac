...
pub type ReportrdyReadclraccW<'a, REG> =
    crate::BitWriter<'a, REG, ReportrdyReadclracc>;
...
pub type ReportrdyRdclraccW<'a, REG> =
    crate::BitWriter<'a, REG, ReportrdyRdclracc>;
...
pub type SamplerdyReadclraccW<'a, REG> =
    crate::BitWriter<'a, REG, SamplerdyReadclracc>;
