...
pub type TasksCalibrateoffset =
    crate::Reg<tasks_calibrateoffset::TasksCalibrateoffsetSpec>;
...
pub type EventsCalibratedone =
    crate::Reg<events_calibratedone::EventsCalibratedoneSpec>;
