...
pub type TswitchspacingW<'a, REG> =
    crate::FieldWriter<'a, REG, 3, Tswitchspacing>;
...
pub type TsamplespacingrefW<'a, REG> =
    crate::FieldWriter<'a, REG, 3, Tsamplespacingref>;
...
pub type TsamplespacingW<'a, REG> =
    crate::FieldWriter<'a, REG, 3, Tsamplespacing>;
...
pub type RepeatpatternW<'a, REG> =
    crate::FieldWriter<'a, REG, 4, Repeatpattern>;
