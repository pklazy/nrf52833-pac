...
pub type AddressRssistartW<'a, REG> =
    crate::BitWriter<'a, REG, AddressRssistart>;
...
pub type DisabledRssistopW<'a, REG> =
    crate::BitWriter<'a, REG, DisabledRssistop>;
...
pub type FramestartBcstartW<'a, REG> =
    crate::BitWriter<'a, REG, FramestartBcstart>;
